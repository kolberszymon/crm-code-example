    ...
    <AuthLayout>
      ...
      <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex justify-center items-center z-50">
        <div className="bg-white p-6 rounded-md shadow-md max-w-lg w-full flex flex-col items-center">          
          <p className="text-[#015640] text-4xl font-extrabold mb-[16px]">Gratulacje!</p>
          <p className="text-[#002d21] text-sm font-normal text-center mb-[24px]">Na Twoją skrzynkę mailową wysłaliśmy szkolenie oraz potwierdzenie płatności.</p>         
          <Link
            href="/trainings"
