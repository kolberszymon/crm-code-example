  ...
  return (
    <AuthLayout>
      ...
      <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex justify-center items-center z-50">
        <div className="bg-white p-6 rounded-md shadow-md max-w-lg w-full flex flex-col items-center">          
          <p className="text-[#015640] text-4xl font-extrabold mb-[16px]">Coś poszło nie tak</p>
          <p className="text-[#002d21] text-sm font-normal text-center mb-[24px]">Spróbuj jeszcze raz lub skontaktuj się z naszym biurem obsługi kontakt@monlib.com</p>         
          <Link
            href="/trainings"
            className={`w-full bg-main-green text-white text-base font-semibold rounded-md py-[10px] mt-[16px] hover:opacity-80 transition-opacity flex items-center justify-center disabled:opacity-70 disabled:bg-gray-300`}                                
          >
            Rozumiem
          </Link>
        </div>
