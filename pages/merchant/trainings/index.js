...
import { TrainingTileMerchant } from "@/components/Custom/TrainingTileMerchant";
        ...
        <div className="space-y-4">
          {trainigs.length === 0 ? (
            ...
            trainigs.map((training, i) => (
              <TrainingTileMerchant key={i} training={training} onDelete={() => openDeleteModal(training.id)} onDuplicate={() => openDuplicateModal(training.id)} />
            ))
          )}
        </div>
