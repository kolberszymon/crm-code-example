    ...
    <AdminLayout path={["Szkolenia", "Lista szkoleń", "Szczegóły"]}>
      <MainComponent>
        ...
        <div className="w-full flex items-start justify-start mt-6">
          <Link href={training.fileUrl} download target="_blank" className="">
            <div className="flex flex-col items-start justify-start">
              <label
                htmlFor="file-upload"
                className="flex flex-row items-start border border-main-gray rounded-md px-[12px] py-[8px] gap-2 hover:bg-main-gray cursor-pointer"
              >
