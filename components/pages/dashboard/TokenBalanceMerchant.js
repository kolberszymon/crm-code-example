...
export default function TokenBalanceMerchant() {
  ...
  return (
    <div className="min-h-[150px] w-[360px] bg-white flex flex-col py-[22px] pl-[16px] items-start justify-center rounded relative overflow-hidden border border-gray-100">
