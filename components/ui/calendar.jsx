...
function Calendar({
  ...
  return (
    (<DayPicker
      ...
      components={{
        IconLeft: ({ ...props }) => <div className="flex items-center justify-center"><ChevronLeft className="h-4 w-4" /></div>,
        IconRight: ({ ...props }) => <div className="flex items-center justify-center"><ChevronRight className="h-4 w-4" /></div>,
      }}
      {...props} />)
  );
}
